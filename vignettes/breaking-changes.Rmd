...
vignette: >
  %\VignetteIndexEntry{Breaking Changes}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

<!-- put this right after the YAML in your Rmd -->
<style type="text/css">
div.table, div.kable, .kable {
...
This vignette documents the changes in function names, parameter names and MPI schema names between GENEAcore version 1.0.1 and GENEAcore version 1.1.0. Use this as a reference when migrating code from older releases.
