# ==============================================================================
# COEL Atom 2.0 JSON builder v1.1
#
# Author: Millen James Theophilus
#
# - Behavioural Bout Model v1.0: uses bouts_df (event/bout table)
# - Rest Activity Model v1.0: derives contiguous events from mpi_data$non_movement
#
# Dependencies: jsonlite (plus base R and utils::URLencode)
# ==============================================================================
...
build_coel_atoms_json <- function(
  ...
  writeLines(json_out, file.path(output_folder, paste0(mpi_data$file_data[["UniqueBinFileIdentifier"]],"_coel_", label_col, "_atoms.json")))
}
...
combine_atoms_to_payload <- function(in_dir,
  ...
  files <- list.files(in_dir, pattern = pattern, full.names = TRUE, recursive = recursive)
